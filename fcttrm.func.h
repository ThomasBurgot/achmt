...
FOQSTP(PTARG,PPRESS)=FOQS(FOEW(PTARG,MAX(0.0_JPRB,SIGN(1.0_JPRB,RTT-PTARG)))/PPRESS)
...
!                PDLEFAR = FODLEW
REAL(KIND=JPRB) :: FDQW
FDQW (PESPFAR, PDLEFAR) = PDLEFAR * PESPFAR * (1.0_JPRB+RETV) / ( 1.0_JPRB+RETV*MAX(0.0_JPRB,(1.0_JPRB-PESPFAR)) ) ** 2._JPRB
