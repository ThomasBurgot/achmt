...
REAL(KIND=JPRB) :: Z0CR, Z2B, Z3B, Z3BC, ZA1, ZAPRIM, ZAT, ZAU,&
 ...
 & ZLOIMR, ZCDIMR, ZDIDMR, ZEPS, ZTEST
...
!PRINT *, 'YRPHY0%USURICL', YRPHY0%USURICL

!PRINT *, 'USURIC', USURICL
...
DO JLON=KIDIA,KFDIA
  !PRINT *, 'JLON_ACHMT=', JLON
  !PRINT *, 'PAPHIF(JLON,KLEV)=', PAPHIF(JLON,KLEV)
  !PRINT *, 'PAPHI(JLON,KLEV)=', PAPHI(JLON,KLEV)
...
!     TIME WIND SPEED.
  ...
  PCD(JLON)=(ZLOI+PSTAB(JLON)*(ZLOS-ZLOI))*PCDN(JLON)/ZU(JLON)
