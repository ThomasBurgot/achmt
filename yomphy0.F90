...
! NCAPEMOD : To set the kind of "CAPE-model"
! WCAPEMOD : A threshold for the maximum of vertical wind 
! RENTRMOD : the lateral entrainment to be used in FPCINCAPE called in ACMTUD
...
REAL(KIND=JPRB)   :: GREDDLI ! REDuction of Detrainment for Liquid and Ice water.
...
REAL(KIND=JPRB) :: GCHECKTE_TTMAX ! Check Model TEndencies: maximal value for T Tendency.
...
INTEGER (KIND=JPIM) :: NCAPEMOD ! To set the kind of "CAPE-model"
REAL    (KIND=JPRB) :: WCAPEMOD ! A threshold for the maximum of vertical wind
REAL    (KIND=JPRB) :: RENTRMOD ! the lateral entrainment (in FPCINCAPE called in ACMTUD)
